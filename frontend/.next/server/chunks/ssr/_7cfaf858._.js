...
"[project]/frontend/src/app/employee/training/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const fetchTrainingTasks = async ()=>{
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/employee/training');
    if (!res.ok) {
...
function TrainingPage() {
    const { data: trainingTasks, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'trainingTasks'
        ],
...
//# sourceMappingURL=_7cfaf858._.js.map